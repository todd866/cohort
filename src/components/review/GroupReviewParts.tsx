  ...
  return (
    <>
      ...
      <div className="h-1 bg-[var(--md-surface-container-highest)]">
        <div
          className="h-full bg-[var(--md-primary)] transition-[width] duration-300 ease-out"
        ...
        {displayOptions.map((option, index) => {
          ...
          return (
            <button
              ...
              className="w-full text-left px-3 py-2.5 rounded-xl border-2 border-[var(--md-outline-variant)] bg-[var(--md-surface-container)] hover:border-[var(--md-primary)] hover:shadow-sm active:scale-[0.99] cursor-pointer transition-colors text-sm flex items-start gap-2.5"
            >
