...
// Server render sites replace this fallback with MCQ.server so internal media
// receives entitlement + sidecar resolution. This global map stays client-safe
// because deep-dive loader maps are also imported into client components.
import { MCQClient as MCQ } from '@/components/content/MCQ.client';
// Likewise, server render sites replace Figure and raw img with their server
// resolver while this fallback remains usable in client-imported MDX modules.
