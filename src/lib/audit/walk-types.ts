...
import type { ConceptThreadMetadata } from './concept-thread-telemetry';
...
export interface WalkMetadata extends Partial<ConceptThreadMetadata> {
  sessionId: string;
  batchId?: string;
...
export interface ConceptThreadWalkMetrics {
  conceptThreadEligibleCount: number;
  conceptThreadPolicyObservedCount: number;
  conceptThreadPolicyCoverage: number | null;
  conceptThreadAppliedCount: number;
  conceptThreadAppliedRate: number | null;
  conceptThreadCompleteAppliedCount: number;
  conceptThreadMedianAgeMs: number | null;
  conceptThreadAgeSampleCount: number;
  conceptThreadMedianInterveningExposures: number | null;
  conceptThreadInterveningExposureSampleCount: number;
  conceptThreadAnsweredAppliedCount: number;
  conceptThreadAppliedCorrectCount: number;
  conceptThreadAppliedCorrectnessRate: number | null;
}
...
export interface Session {
  ...
  /** Append-only delivery ratings. Metrics collapse these by serveDecisionId. */
...
export interface SessionMetrics extends ConceptThreadWalkMetrics {
  itemCount: number;
...
export interface RollupMetrics extends ConceptThreadWalkMetrics {
  sessionCount: number;
  itemCount: number;
