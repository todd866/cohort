...
export interface OfflineSnapshot {
  ...
  /** Current reserve coverage, distinct from historical figures in the cache. */
  packTargetItems?: number;
  packFiguresTotal?: number;
  packFiguresCached?: number;
  packFiguresMissing?: number;
  packRequiredImagesMissing?: number;
  outboxAuthBlocked?: boolean;
...
export function buildSnapshot(
  ...
  return {
    ...
    ...(deps.packTargetItems !== undefined ? { packTargetItems: deps.packTargetItems } : {}),
    ...(deps.packFiguresTotal !== undefined ? { packFiguresTotal: deps.packFiguresTotal } : {}),
    ...(deps.packFiguresCached !== undefined ? { packFiguresCached: deps.packFiguresCached } : {}),
    ...(deps.packFiguresMissing !== undefined ? { packFiguresMissing: deps.packFiguresMissing } : {}),
    ...(deps.packRequiredImagesMissing !== undefined
      ? { packRequiredImagesMissing: deps.packRequiredImagesMissing } : {}),
    ...(deps.outboxAuthBlocked !== undefined ? { outboxAuthBlocked: deps.outboxAuthBlocked } : {}),
