...
function editFormFor(profile: ProfileIdentity): EditForm {
  return {
    ...
    aiming: profile.feedProfileExplicit.aiming || '',
  };
}
...
export default function ProfilePageClient({
  ...
  const handleSave = async () => {
    ...
    const feedProfileExplicit = {
      ...
      aiming: editForm.aiming || undefined,
    };
        ...
        <div className="min-w-0 flex-1">
          ...
          {!editing
            && (
              ...
              || profile.feedProfileExplicit.aiming
            ) ? (
              <div className="mt-2 flex flex-wrap gap-1.5">
                ...
                {profile.feedProfileExplicit.aiming ? (
                  <span className="rounded-full bg-[var(--md-surface-container-highest)] px-2.5 py-0.5 text-xs text-[var(--md-on-surface)]">
                    Aiming: {profile.feedProfileExplicit.aiming}
                  </span>
                ) : null}
              </div>
        ...
        <div className="mt-4 space-y-3 sm:pl-20">
          ...
          <div>
            ...
            <input
              type="text"
              id="profile-aiming"
              value={editForm.aiming}
              onChange={(event) => setEditForm({ ...editForm, aiming: event.target.value })}
              placeholder="e.g. cardiothoracic surgery, or emergency"
              className="w-full rounded-lg border border-[var(--md-outline)] bg-[var(--md-surface-container)] px-3 py-2 text-sm text-[var(--md-on-surface)]"
            />
          </div>
