...
- Original educational prose, questions, cards, diagrams, and documentation
  ...
  the repository.
- The original generated figures, prompts and teaching notes explicitly listed
  in [`open-content/medical-figures/manifest.json`](./open-content/medical-figures/manifest.json)
  are instead licensed under the [MIT License](./open-content/medical-figures/LICENSE).
  This collection includes a reusable figure bundle and a standalone Anki deck.
  Its MIT grant does not change the licences of other MD3 or third-party figures.
- The original anatomy example and its construction/annotation materials in
  [`open-content/anatomy-scaffolds/left-cdh`](./open-content/anatomy-scaffolds/left-cdh/README.md)
  are also released under their included MIT licence.
